...
namespace GenericBclInterfaceTests.System
{
    ...
    /// <summary>
    /// Provides test cases for structs implementing the <see cref="IComparable&lt;T&gt;" interface.
    /// </summary>
    /// <typeparam name="T">The type of the comparable.</typeparam>
    public class TestIComparableOfTFor<T> : BaseTestIComparable<T> where T : struct, IComparable<T>
    {
        /// <summary>
        ...
        public TestIComparableOfTFor([DisallowNull] Func<T> createInstance,
